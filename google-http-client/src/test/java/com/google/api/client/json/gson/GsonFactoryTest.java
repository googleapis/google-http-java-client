...
public class GsonFactoryTest extends AbstractJsonFactoryTest {
  ...
  private static final String JSON_FEED_PRETTY = "{" + Strings.LINE_SEPARATOR + "  \"entries\": ["
      + Strings.LINE_SEPARATOR + "    {" + Strings.LINE_SEPARATOR + "      \"title\": \"foo\""
      + Strings.LINE_SEPARATOR + "    }," + Strings.LINE_SEPARATOR + "    {"
      + Strings.LINE_SEPARATOR + "      \"title\": \"bar\"" + Strings.LINE_SEPARATOR + "    }"
      + Strings.LINE_SEPARATOR + "  ]" + Strings.LINE_SEPARATOR + "}";
