...
public interface ObjectParser {
   ...
   */
  <T> T parseAndClose(InputStream in, Charset charset, Class<T> dataClass) throws Exception;
   ...
   */
  Object parseAndClose(InputStream in, Charset charset, Type dataType) throws Exception;
   ...
   * @param dataClass class into which the data is parsed
   */
  <T> T parseAndClose(Reader reader, Class<T> dataClass) throws Exception;
   ...
   * @param dataType type into which the data is parsed
   */
  Object parseAndClose(Reader reader, Type dataType) throws Exception;
}
