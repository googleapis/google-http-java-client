...
public final class NetHttpTransport extends HttpTransport {
  ...
  private static class PqcPeerHostSSLSocketFactory extends javax.net.ssl.SSLSocketFactory {
    private final javax.net.ssl.SSLSocketFactory delegate;
    private final String host;

    PqcPeerHostSSLSocketFactory(javax.net.ssl.SSLSocketFactory delegate, String host) {
    ...
    public java.net.Socket createSocket(
        java.net.Socket s, String host, int port, boolean autoClose) throws java.io.IOException {
    ...
    @Override
    public java.net.Socket createSocket(
        String host, int port, java.net.InetAddress localAddress, int localPort)
        throws java.io.IOException, java.net.UnknownHostException {
    ...
    public java.net.Socket createSocket(java.net.InetAddress address, int port)
      ...
      plainSocket.connect(new java.net.InetSocketAddress(address, port));
    ...
    public java.net.Socket createSocket(
        ...
        throws java.io.IOException {
      java.net.Socket plainSocket = new java.net.Socket();
      plainSocket.bind(new java.net.InetSocketAddress(localAddress, localPort));
      plainSocket.connect(new java.net.InetSocketAddress(address, port));
      return delegate.createSocket(plainSocket, this.host, port, true);
    }
  }
