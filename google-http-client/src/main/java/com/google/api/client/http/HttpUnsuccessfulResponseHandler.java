...
public interface HttpUnsuccessfulResponseHandler {
   ...
   * @param supportsRetry Whether there will actually be a retry if this handler return
   * {@code true}. Some handlers may want to have an effect only when there will actually be a retry
